...
@Autonomous(name = "Auto_Trisler_Version_TimeIntake", group = "Auton")
public class Auto_Trisler_Version extends LinearOpMode {
    ...
    // How far to move (negative = backward)
    private static final double FORWARD_INCHES = -8.5;
    ...
    public void runOpMode() throws InterruptedException {
        ...
        leftLift.setPosition(LIFT_POS_DOWN);
        ...
        // --------- Fire first preloaded ball (lift once) ----------
        ...
        // --------- Drive BACKWARD a precise distance (inches) using encoders ----------
        driveForwardInches(FORWARD_INCHES, 0.30);
    ...
    private void moveLiftTo(double targetPos, long travelMs) throws InterruptedException {
        ...
        double finalRightTarget = 1.0 - targetPos;
        ...
        for (int s = 1; s <= steps && opModeIsActive(); s++) {
            ...
            double posL = startLeft + (targetPos - startLeft) * t;
            double posR = startRight + (finalRightTarget - startRight) * t;
