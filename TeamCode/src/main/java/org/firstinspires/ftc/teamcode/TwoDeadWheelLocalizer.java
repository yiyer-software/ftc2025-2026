...
public final class TwoDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = -2626.582083939566; // y position of the parallel encoder (in tick units)
        public double perpXTicks = -7996.004663079073; // x position of the perpendicular encoder (in tick units)
    }
