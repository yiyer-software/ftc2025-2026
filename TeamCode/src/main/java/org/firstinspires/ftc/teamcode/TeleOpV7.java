...
@TeleOp(name = "TeleOpV7", group = "Competition")
public class TeleOpV7 extends LinearOpMode {
    ...
    private void handleBackup() {
        if (gamepad1.x && !lastX && !isBackingUp) {
            isBackingUp = true;
    ...
    private void updateTelemetry() {
        ...
        telemetry.addData("FL Vel (t/s)", "%.0f", frontLeft.getVelocity());
        telemetry.addData("FR Vel (t/s)", "%.0f", frontRight.getVelocity());
        telemetry.addData("BL Vel (t/s)", "%.0f", backLeft.getVelocity());
        telemetry.addData("BR Vel (t/s)", "%.0f", backRight.getVelocity());
        telemetry.update();
    }
}