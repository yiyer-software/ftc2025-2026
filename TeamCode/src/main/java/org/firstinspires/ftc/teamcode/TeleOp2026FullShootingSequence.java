...
public class TeleOp2026V1 extends LinearOpMode {
    ...
    private void shootingSequence(){
        ...
        //Set velocity for both flywheel before shooting all 3 balls
        ...
        switch (shootState) {
            case 0: //Make sure flywheels are spinning
                if (!flywheelsStarted) {
                    flywheelsStarted = true;
                }
                shootState = 1;
            ...
            case 2: //0.25 second delay between sorter moving and the lfiitng sequence
                if (!sortMotor.isBusy()) {
